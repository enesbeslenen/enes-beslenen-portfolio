...
export const projectsData: Record<Lang, Project[]> = {
  tr: [
    ...
    {
      id: 2,
      title: "Çağdaş Ocakbaşı — Restoran Tanıtım Sitesi",
      description:
        "Şanlıurfa'daki Çağdaş Ocakbaşı restoranı için geliştirilmiş, mobil uyumlu ve SEO odaklı tek sayfalık tanıtım sitesi. Menü, galeri, WhatsApp rezervasyonu ve Google Maps entegrasyonu ile müşterilerin restorana hızlıca ulaşmasını sağlar.",
      category: "Landing Page / Kurumsal Tanıtım",
      tags: ["React 19", "TypeScript", "TanStack Start", "TanStack Router", "Tailwind CSS 4", "Vite", "Nitro", "Vercel"],
      href: null,
      live: "https://www.urfacagdasocakbasi.com",
      image: "/projects/cagdas-ocakbasi.png",
      featured: true,
      gradient: "from-orange-500/20 via-emerald-500/10 to-transparent",
      year: "2026",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      live: "https://sofra-lokantasi.vercel.app",
  ...
  en: [
    ...
    {
      id: 2,
      title: "Çağdaş Ocakbaşı — Restaurant Showcase Website",
      description:
        "A mobile-friendly, SEO-focused single-page showcase website built for Çağdaş Ocakbaşı restaurant in Şanlıurfa. Menu, gallery, WhatsApp reservations, and Google Maps integration help customers reach the restaurant quickly.",
      category: "Landing Page / Corporate Showcase",
      tags: ["React 19", "TypeScript", "TanStack Start", "TanStack Router", "Tailwind CSS 4", "Vite", "Nitro", "Vercel"],
      href: null,
      live: "https://www.urfacagdasocakbasi.com",
      image: "/projects/cagdas-ocakbasi.png",
